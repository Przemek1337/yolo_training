...
def convert_json_to_yolo(json_file, json_dir, img_dir, output_label_dir, output_image_dir):
    ...
    label_output_file = os.path.join(output_label_dir, os.path.splitext(json_file)[0] + ".txt")
...
json_dir = r'C:\Users\przem\Desktop\tuto_dataset\ann'  # Katalog z plikami JSON
img_dir = r'C:\Users\przem\Desktop\tuto_dataset\img'  # Katalog z obrazami
output_label_dir = r'C:\Users\przem\Desktop\tuto_dataset\labels'  # Katalog docelowy etykiet YOLO
output_image_dir = r'C:\Users\przem\Desktop\tuto_dataset\out_img'  # Katalog docelowy obrazów
